...
console.log('ENV FILE PATH:', (0, path_1.resolve)(process.cwd(), 'src/config', `.env.${process.env.ENVIRONMENT || 'development'}`));
    ...
    (0, common_1.Module)({
        imports: [
            config_1.ConfigModule.forRoot({
                isGlobal: true,
                envFilePath: (0, path_1.resolve)(process.cwd(), 'src/config', `.env.${process.env.ENVIRONMENT || 'development'}`),
